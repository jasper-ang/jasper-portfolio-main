...
const Projects: React.FC = () => {
  ...
  return (
    <div id="projects" className="bg-base-200 px-4 py-6 text-base-content">
      <div className="mb-12">
        <h2 className="flex items-center text-3xl font-bold text-base-content">
          <svg
            ...
            height={32}
            fill="currentColor"
            className="shadow-glowSecondary ml-4 mr-8 h-8 w-8 bg-base-200 text-base-200"
          >
      ...
      <div className="rounded bg-base-100 px-4 py-6 shadow-lg">
        ...
        {showDetails && (
          <div className="details-content shadow-glowNeutral rounded border border-neutral bg-base-100 p-4">
